  ...
  return (
    <div className="space-y-6">
              ...
              <div className="inline-flex rounded-xl border border-slate-200 bg-slate-50 p-1 text-xs font-medium text-slate-600 dark:border-slate-700 dark:bg-slate-900/60 dark:text-slate-400">
                <button
                  ...
                  className={`rounded-lg px-3 py-1 transition ${
                    filterJenis === "all" ? "bg-white text-slate-900 shadow-xs font-semibold dark:bg-slate-900 dark:text-white" : "hover:text-slate-900 dark:hover:text-white"
                  }`}
                >
                  Semua
                </button>
                <button
                  ...
                  className={`rounded-lg px-3 py-1 transition ${
                    filterJenis === "pemasukan" ? "bg-emerald-50 text-emerald-700 shadow-xs font-semibold dark:bg-emerald-900/20 dark:text-emerald-400" : "hover:text-emerald-700 dark:hover:text-emerald-400"
                  }`}
                >
                  Pemasukan
                </button>
                <button
                  ...
                  className={`rounded-lg px-3 py-1 transition ${
                    filterJenis === "pengeluaran" ? "bg-rose-50 text-rose-700 shadow-xs font-semibold dark:bg-rose-900/20 dark:text-rose-400" : "hover:text-rose-700 dark:hover:text-rose-400"
                  }`}
                >
                  Pengeluaran
                </button>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm focus:border-brand-500 focus:outline-none dark:border-slate-600 dark:bg-slate-900"
            />
            {buktiPreview && (
              <div className="mt-2 flex items-center gap-3 rounded-lg border border-slate-200 bg-slate-50 p-2 dark:border-slate-700 dark:bg-slate-900/60">
                ...
                <div className="flex-1 text-xs text-slate-600 dark:text-slate-400">
                  <p className="font-semibold text-slate-800 dark:text-slate-200">Bukti gambar dipilih</p>
                ...
                <button
                  ...
                  className="rounded-lg border border-red-300 bg-white px-2.5 py-1 text-xs text-red-600 hover:bg-red-50 dark:bg-slate-900"
                >
                  Hapus Bukti
                </button>
              </div>
      ...
      <Modal open={Boolean(viewBuktiUrl)} onClose={() => setViewBuktiUrl(null)} title="Bukti Struk Transaksi">
        {viewBuktiUrl && (
          <div className="space-y-4">
            <div className="max-h-[65vh] overflow-auto rounded-xl border border-slate-200 bg-slate-50 p-2 flex items-center justify-center dark:border-slate-700 dark:bg-slate-900/60">
              <img
                src={viewBuktiUrl}
                alt="Bukti Transaksi"
            ...
            <div className="flex justify-end gap-2 pt-2 border-t border-slate-100 dark:border-slate-800">
              <a
                ...
                className="rounded-lg border border-brand-500 bg-brand-50 px-3.5 py-1.5 text-xs font-semibold text-brand-700 hover:bg-brand-100 dark:bg-brand-900/20 dark:text-brand-400"
              >
                Unduh Gambar
              </a>
              <button
                ...
                className="rounded-lg border border-slate-300 bg-white px-3.5 py-1.5 text-xs font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-800"
              >
                Tutup
              </button>
            </div>
